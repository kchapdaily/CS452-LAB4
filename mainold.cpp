...
void initLights(){
  ...
  lightProperty light0;
  material0.mat_specular[0] = 1.0;
  material0.mat_specular[1] = 1.0;
  material0.mat_specular[2] = 1.0;
  material0.mat_specular[3] = 1.0;
  
  material0.mat_shininess[0] = 50.0;

  light0.light_ambient[0] = 0.2;
  light0.light_ambient[1] = 0.2;
  light0.light_ambient[2] = 0.2;
  light0.light_ambient[3] = 1;
  
  light0.light_diffuse[0] = 1.0;
  light0.light_diffuse[1] = 1.0;
  light0.light_diffuse[2] = 1.0;
  light0.light_diffuse[3] = 1.0;
  
  light0.light_specular[0] = 1.0;
  light0.light_specular[1] = 1.0;
  light0.light_specular[2] = 1.0;
  light0.light_specular[3] = 1.0;
  
  light0.light_position[0] = 20.0;
  light0.light_position[1] = 20.0;
  light0.light_position[2] = 20.0;
  light0.light_position[3] = 0.0;

  glClearColor(0.0, 0.0, 0.0, 0.0);
  glShadeModel(GL_SMOOTH);

  glMaterialfv(GL_FRONT, GL_SPECULAR, material0.mat_specular);
  glMaterialfv(GL_FRONT, GL_SHININESS, material0.mat_shininess);

  glLightfv(GL_LIGHT0, GL_POSITION, light0.light_position);
  glLightfv(GL_LIGHT0, GL_AMBIENT, light0.light_ambient);
  glLightfv(GL_LIGHT0, GL_DIFFUSE, light0.light_diffuse);
  glLightfv(GL_LIGHT0, GL_SPECULAR, light0.light_specular);
  glLightfv(GL_LIGHT0, GL_POSITION, light0.light_position);

  glLightModelfv(GL_LIGHT_MODEL_AMBIENT, light0.light_ambient);
